...
This candidate consolidates the changes since v1.4.0. The final public claim is
...
Upgrade from v1.4.0 using the wheel matching the supported Python and platform
